...
public record CadastrarContaRequest(
    ...
    @Schema(
        description = "Código ISO da moeda da conta. Transferências exigem a mesma moeda nos dois lados.",
        example = "BRL",
        minLength = 3,
        maxLength = 3)
    @NotBlank String moeda,
    @Schema(
        description = "Saldo inicial da conta na data informada; aceita valores positivos ou negativos.",
        example = "1500.00",
        format = "double")
