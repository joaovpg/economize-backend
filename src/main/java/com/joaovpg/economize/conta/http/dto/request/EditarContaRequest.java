...
public record EditarContaRequest(
    ...
    @Schema(description = "Código ISO da moeda da conta.", example = "BRL", minLength = 3, maxLength = 3)
    @NotBlank String moeda,
    @Schema(description = "Saldo inicial da conta na data informada.", example = "1500.00", format = "double")
    ...
    @Schema(description = "Define se a conta fica disponível para novas operações.", example = "true")
