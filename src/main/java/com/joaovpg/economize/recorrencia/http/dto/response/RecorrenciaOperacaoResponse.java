...
public record RecorrenciaOperacaoResponse(
    ...
    @Schema(
            ...
            format = "double")
        BigDecimal valor,
    @Schema(description = "Data financeira efetiva.", example = "2026-04-05", format = "date")
    ...
    @Schema(
            ...
            format = "date-time")
        Instant efetivadoEm,
    @Schema(description = "Conta da ocorrência.", example = "00000000-0000-0000-0000-000000000001")
        UUID contaId,
    ...
    @Schema(description = "Regra RFC 5545 do segmento.", example = "FREQ=MONTHLY;BYMONTHDAY=5")
        String rrule,
    @Schema(
    ...
    @Schema(description = "Política de ajuste de datas.", example = "PADRAO")
