...
public record UsuarioResponse(
    @Schema(description = "Identificador do usuário.", example = "00000000-0000-0000-0000-000000000001")
    UUID id,
    ...
    @Schema(description = "Timezone IANA do usuário.", example = "America/Sao_Paulo") String timezone) {}
