...
public record AlterarTransacaoRequest(
    @Schema(description = "Conta ativa da transação; deve usar a mesma moeda da conta atual.", example = "00000000-0000-0000-0000-000000000001")
    @NotNull UUID contaId,
    @Schema(description = "Categoria opcional; envie null para remover a categoria.", nullable = true)
    UUID categoriaId,
    @Schema(description = "Situação da transação; ao voltar para PLANEJADA, efetivadoEm é removido.", example = "PLANEJADA")
    ...
    @Schema(description = "Valor positivo da operação, com até 4 casas decimais.", example = "250.75", minimum = "0.0001", format = "double")
